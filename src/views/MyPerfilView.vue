      ...
      <div v-else>
        ...
        <ul v-else class="space-y-6">
            ...
            <div class="flex flex-col p-6 w-[100%]">
              ...
              <p class="text-white leading-relaxed flex-grow break-words">{{ post.content }}</p>

              <div
              class="flex justify-end items-center gap-4 mt-auto pt-4 border-t border-gray-700"
              >
              <svg
